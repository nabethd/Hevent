...
class AppStrings(val lang: AppLanguage, private val res: Resources) {
    ...
    val recurOneTime: String = res.getString(R.string.recur_one_time)
    val recurOneTimeShort: String = res.getString(R.string.recur_one_time_short)
    val oneTimeNotice: String = res.getString(R.string.one_time_notice)
